    ...
    class SmartProcess
    {
        ...
        void ImageProcess()//图像行处理
        {
            ...
            if (flag_left_round == 0 && flag_right_round == 0 && flag_stopcar == 0)
            {
                ...
                if (flag_ramp == 0)
                {
                    ...
                    if (flag_stopcar == 0)
                    {
                        ...
                        if ((parkingFee_jishu_25 >= 5&& parkingFee_jishu_25 <= 10) || (parkingFee_jishu_29 >= 5&& parkingFee_jishu_29 <= 10))
                        {
                            flag_stopcar = 1;
                        }
                    }
            ...
            if (flag_enter_changzhidao == 1 &&
                ((left_turn_down_wandao[0] < 35 && left_turn_down_wandao[0] >= 17 && (right_turn_down_wandao[0] == 0 || right_turn_down_wandao[0] > (left_turn_down_wandao[0] + 8)) && Compare_abs((R_black[44] + R_black[20]) / 2, R_black[32]) == 0 && flag_shizi_right==0)
                || (right_turn_down_wandao[0] < 35 && right_turn_down_wandao[0] >= 17 && (left_turn_down_wandao[0] == 0 || left_turn_down_wandao[0] > (right_turn_down_wandao[0] + 8)) && Compare_abs((L_black[44] + L_black[20]) / 2, L_black[32]) == 0 && flag_shizi_left==0)
                ))
            {
                flag_huaxing_long = 1;
            }
